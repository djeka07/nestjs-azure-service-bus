...
export interface BaseAzureServiceBusProviderAsyncOption extends Pick<ModuleMetadata, 'imports'> {
...
export interface AzureServiceBusProviderAsyncOptions extends BaseAzureServiceBusProviderAsyncOption {
    name: string;
}
